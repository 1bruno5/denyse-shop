...
<div class="bg-gray-100 h-auto pt-13 pb-8">
  ...
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-x-2 gap-y-4 justify-items-center px-4 md:px-8 lg:px-20 mt-10">
...
<div class="flex flex-col lg:flex-row gap-16 lg:gap-16 ">
  ...
  >
<div class="">
    <h3 class=" text-xl md:text-2xl lg:text-3xl font-bold text-gray-700 text-center lg:text-left">Cook Smarter. Live Better.</h3>
