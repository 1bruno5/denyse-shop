    ...
    <div class="absolute inset-0 flex bg-black/40 ">
      ...
      <p class="font-bold  text-white text-xl sm:text-3xl lg:text-4xl">Your perfect kitchen starts here with<br></p>
        <p class="mt-2 lg:mt-6 font-bold  text-xl sm:text-3xl lg:text-4xl text-white"> quality equipment for every<br></p>
         ...
         <button class="bg-red-700 rounded-md px-8 py-2 text-white text-xl mt-20 "><RouterLink to="/products" class="text-base justify-center ml-2 mb-3">Shop Now</RouterLink></button>
      </div>
    </div>
  </div>
...
<div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mb-8 justify-items-center px-4 sm:px-8 md:px-16 lg:px-20">
...
<div class="">
  ...
  <div class="mt-10 text-sm lg:text-lg text-center md:text-left">
    ...
    <button class="bg-red-800 text-white py-3 px-8 rounded-md mt-16 hover:bg-red-700 "><RouterLink to="/about" class="text-sm">Learn More About Us</RouterLink></button>
  </div>
</div>
</div>
</div>
